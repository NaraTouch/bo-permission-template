...
INSERT INTO `academics` VALUES (1,2,'grade5',1,'2023-10-27','2023-10-29','2023-10-23 01:32:20','2023-10-23 08:58:05',1,1,1),(2,1,'grade6',1,'2023-10-23','2023-10-26','2023-10-23 01:45:17','2023-10-23 08:57:25',1,1,1);
...
INSERT INTO `account_employee_salaries` VALUES (1,1,'2023-10',1300,'2023-10-20 08:48:34','2023-10-20 08:48:34');
...
INSERT INTO `account_other_costs` VALUES (1,'2023-10-18',1100,'sewe','202310190740small-product-placeholder.png','2023-10-19 00:40:01','2023-10-19 00:40:01');
...
CREATE TABLE `admins` (
  ...
  `secret_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Test',
...
INSERT INTO `assign_students` VALUES (1,12,NULL,2,1,1,1,'2023-10-18 09:41:33','2023-10-23 09:34:07',1),(2,19,NULL,1,1,1,1,'2023-10-18 10:16:10','2023-10-23 09:34:10',2),(3,20,NULL,1,1,1,1,'2023-10-19 23:38:14','2023-10-23 09:33:55',2),(4,22,NULL,2,1,1,1,'2023-10-23 09:23:31','2023-10-23 09:33:23',1),(5,12,NULL,1,1,1,1,'2023-10-18 09:41:33','2023-10-18 09:41:33',2);
...
INSERT INTO `assign_subjects` VALUES (1,1,1,125,60,22,'2023-10-18 09:38:45','2023-10-18 09:38:45');
...
INSERT INTO `designations` VALUES (1,'By Monthly','2023-10-18 09:39:04','2023-10-18 09:39:04');
...
INSERT INTO `discount_students` VALUES (1,1,1,0,'2023-10-18 09:41:33','2023-10-18 09:41:33'),(2,2,1,0,'2023-10-18 10:16:10','2023-10-18 10:16:10'),(3,3,1,0,'2023-10-19 23:38:14','2023-10-19 23:38:14'),(4,4,1,0,'2023-10-23 09:23:31','2023-10-23 09:23:31');
...
INSERT INTO `employee_attendances` VALUES (1,1,'2023-10-20','Present','2023-10-20 08:47:44','2023-10-20 08:47:44');
...
INSERT INTO `employee_salary_logs` VALUES (1,1,NULL,800,800,'2023-10-20','2023-10-20 08:43:18','2023-10-20 08:43:18'),(2,1,800,1800,1000,'2023-11-19','2023-10-20 08:43:38','2023-10-20 08:43:38'),(3,1,1800,1300,-500,'2023-12-09','2023-10-20 08:44:36','2023-10-20 08:44:36');
...
INSERT INTO `exam_types` VALUES (1,'IELS','2023-10-18 08:55:59','2023-10-18 08:56:19');
...
INSERT INTO `fee_categories` VALUES (1,'By Year','2023-10-18 08:55:07','2023-10-18 08:55:07'),(2,'By Monthly','2023-10-18 08:55:15','2023-10-18 08:55:15');
...
INSERT INTO `fee_category_amounts` VALUES (3,1,1,1000,'2023-10-19 23:37:01','2023-10-19 23:37:01'),(4,1,2,600,'2023-10-19 23:37:01','2023-10-19 23:37:01'),(5,2,1,300,'2023-10-23 08:34:42','2023-10-23 08:34:42'),(6,2,2,100,'2023-10-23 08:34:42','2023-10-23 08:34:42');
...
CREATE TABLE `marks_grades` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `grade_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `grade_point` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `start_marks` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `end_marks` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `moderators` VALUES (1,'Moderator','Moderator@gmail.com','2023-09-25 01:50:26','$2y$10$3wbf.phM87gCZPhJzwliRu.VhIoUuyKJ1F1icMURMZa/9JowTiat.','Test','012345687','phnom penh','Male','202310201528istockphoto-1271410315-612x612.jpg','Employee Father','Employee Mother','Islam',NULL,'2023-10-19',NULL,1,1300,1,NULL,NULL,NULL,'2023-09-25 01:50:26','2023-10-20 08:44:36');
...
INSERT INTO `school_subjects` VALUES (1,'Math','2023-10-18 08:56:28','2023-10-18 08:56:28');
...
INSERT INTO `student_classes` VALUES (1,'elementary','2023-10-18 08:49:01','2023-10-18 08:49:01'),(2,'Garden','2023-10-19 23:36:46','2023-10-19 23:36:46');
...
INSERT INTO `student_groups` VALUES (1,'Full Time','2023-10-18 08:54:01','2023-10-18 08:54:01');
...
INSERT INTO `student_shifts` VALUES (1,'Morning','2023-10-18 08:54:13','2023-10-18 08:54:13'),(2,'Afternoon','2023-10-18 08:54:22','2023-10-18 08:54:22');
...
INSERT INTO `student_years` VALUES (1,'2023','2023-10-18 08:53:53','2023-10-18 08:53:53');
...
CREATE TABLE `sys_methods` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `sys_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `sys_modules` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `group` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'app' COMMENT 'app=(none group), sys=(system setting group), repo=(report group)',
  `position` int DEFAULT NULL,
...
INSERT INTO `sys_modules` VALUES (1,'Manage Module',NULL,'2023-09-25 06:39:00','2023-09-27 01:38:01','sys',10,'codesandbox',NULL),(2,'Manage Admin',NULL,'2023-09-25 13:08:05','2023-10-20 09:28:57','sys',11,'toggle-left','admin.members'),(3,'Role',NULL,'2023-09-25 13:39:53','2023-10-20 09:29:39','sys',12,'airplay','admin.role'),(4,'Manage User',NULL,'2023-09-25 13:42:21','2023-09-27 11:29:36','app',2,'users','admin.users'),(5,'Profile',NULL,'2023-09-25 13:44:52','2023-10-20 09:30:01','app',13,'user','admin.profile'),(6,'Setup Management',NULL,'2023-09-25 13:54:12','2023-09-27 11:30:16','app',3,'credit-card','admin.setups'),(7,'Student Mangement',NULL,'2023-09-26 00:32:53','2023-09-27 11:30:45','app',4,'hard-drive','admin.students'),(11,'Employee Management',NULL,'2023-09-26 00:45:23','2023-09-27 11:30:59','app',4,'package','admin.employees'),(12,'Marks Management',NULL,'2023-09-26 01:09:05','2023-09-27 11:32:50','app',6,'edit-2','admin.marks'),(13,'Account Management',NULL,'2023-09-26 01:20:16','2023-09-27 11:33:09','app',7,'inbox','admin.accounts'),(14,'Report Management',NULL,'2023-09-26 01:25:49','2023-10-20 09:27:06','repo',9,'server','admin.reports'),(15,'Dashboard',NULL,'2023-09-26 01:33:35','2023-09-27 11:29:19','app',1,'pie-chart','admin.dashboard'),(16,'Log Out',NULL,'2023-09-27 01:01:34','2023-10-20 09:28:21','sys',14,'lock','admin.logout'),(17,'Manage Academy',NULL,'2023-10-20 09:23:04','2023-10-20 09:27:16','app',8,'flag','admin.academy');
...
CREATE TABLE `sys_roles` (
  ...
  `permission_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `role` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'admin=head of sotware,operator=computer operator,user=employee',
  `join_date` date DEFAULT NULL,
  `designation_id` int DEFAULT NULL,
  `salary` double DEFAULT NULL,
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '0=inactive,1=active',
...
-- Dump completed on 2023-11-13  2:35:35
